...
using Magentix.Infrastructure.Data.BinarySerializer;
using Magentix.Infrastructure.Settings;

namespace Magentix.Infrastructure.Data.Text
{
    public class TextFileWorkspace : IWorkspace, IReadOnlyWorkspace
    {
        ...
        {
            return Path.GetDirectoryName(Assembly.GetCallingAssembly().Location) + "\\MagentixDB.txt";
        }
